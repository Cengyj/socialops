...
// HasSocialAccounts applies the HasEdge predicate on the "social_accounts" edge.
func HasSocialAccounts() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasSocialAccountsWith applies the HasEdge predicate on the "social_accounts" edge with a given conditions (other predicates).
func HasSocialAccountsWith(preds ...predicate.SocialAccount) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSocialAccountsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasSocialTaskLogs applies the HasEdge predicate on the "social_task_logs" edge.
func HasSocialTaskLogs() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasSocialTaskLogsWith applies the HasEdge predicate on the "social_task_logs" edge with a given conditions (other predicates).
func HasSocialTaskLogsWith(preds ...predicate.SocialTaskLog) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSocialTaskLogsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasSocialIps applies the HasEdge predicate on the "social_ips" edge.
func HasSocialIps() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasSocialIpsWith applies the HasEdge predicate on the "social_ips" edge with a given conditions (other predicates).
func HasSocialIpsWith(preds ...predicate.SocialIP) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSocialIpsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
