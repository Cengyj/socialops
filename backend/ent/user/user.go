...
const (
	...
	// EdgeSocialAccounts holds the string denoting the social_accounts edge name in mutations.
	EdgeSocialAccounts = "social_accounts"
	// EdgeSocialTaskLogs holds the string denoting the social_task_logs edge name in mutations.
	EdgeSocialTaskLogs = "social_task_logs"
	// EdgeSocialIps holds the string denoting the social_ips edge name in mutations.
	EdgeSocialIps = "social_ips"
	...
	// SocialAccountsTable is the table that holds the social_accounts relation/edge.
	SocialAccountsTable = "social_accounts"
	// SocialAccountsInverseTable is the table name for the SocialAccount entity.
	// It exists in this package in order to avoid circular dependency with the "socialaccount" package.
	SocialAccountsInverseTable = "social_accounts"
	// SocialAccountsColumn is the table column denoting the social_accounts relation/edge.
	SocialAccountsColumn = "assigned_user_id"
	// SocialTaskLogsTable is the table that holds the social_task_logs relation/edge.
	SocialTaskLogsTable = "social_task_logs"
	// SocialTaskLogsInverseTable is the table name for the SocialTaskLog entity.
	// It exists in this package in order to avoid circular dependency with the "socialtasklog" package.
	SocialTaskLogsInverseTable = "social_task_logs"
	// SocialTaskLogsColumn is the table column denoting the social_task_logs relation/edge.
	SocialTaskLogsColumn = "user_id"
	// SocialIpsTable is the table that holds the social_ips relation/edge.
	SocialIpsTable = "social_ips"
	// SocialIpsInverseTable is the table name for the SocialIP entity.
	// It exists in this package in order to avoid circular dependency with the "socialip" package.
	SocialIpsInverseTable = "social_ips"
	// SocialIpsColumn is the table column denoting the social_ips relation/edge.
	SocialIpsColumn = "user_id"
...
// BySocialAccountsCount orders the results by social_accounts count.
func BySocialAccountsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newSocialAccountsStep(), opts...)
	}
}

// BySocialAccounts orders the results by social_accounts terms.
func BySocialAccounts(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newSocialAccountsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}

// BySocialTaskLogsCount orders the results by social_task_logs count.
func BySocialTaskLogsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newSocialTaskLogsStep(), opts...)
	}
}

// BySocialTaskLogs orders the results by social_task_logs terms.
func BySocialTaskLogs(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newSocialTaskLogsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}

// BySocialIpsCount orders the results by social_ips count.
func BySocialIpsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newSocialIpsStep(), opts...)
	}
}

// BySocialIps orders the results by social_ips terms.
func BySocialIps(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newSocialIpsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newSocialAccountsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(SocialAccountsInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, SocialAccountsTable, SocialAccountsColumn),
	)
}
func newSocialTaskLogsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(SocialTaskLogsInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, SocialTaskLogsTable, SocialTaskLogsColumn),
	)
}
func newSocialIpsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(SocialIpsInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, SocialIpsTable, SocialIpsColumn),
	)
}
