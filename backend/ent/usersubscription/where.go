...
// PlanPlatform applies equality check predicate on the "plan_platform" field. It's identical to PlanPlatformEQ.
func PlanPlatform(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldPlanPlatform, v))
}
...
// PlanPlatformEQ applies the EQ predicate on the "plan_platform" field.
func PlanPlatformEQ(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldPlanPlatform, v))
}

// PlanPlatformNEQ applies the NEQ predicate on the "plan_platform" field.
func PlanPlatformNEQ(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNEQ(FieldPlanPlatform, v))
}

// PlanPlatformIn applies the In predicate on the "plan_platform" field.
func PlanPlatformIn(vs ...string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldIn(FieldPlanPlatform, vs...))
}

// PlanPlatformNotIn applies the NotIn predicate on the "plan_platform" field.
func PlanPlatformNotIn(vs ...string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNotIn(FieldPlanPlatform, vs...))
}

// PlanPlatformGT applies the GT predicate on the "plan_platform" field.
func PlanPlatformGT(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGT(FieldPlanPlatform, v))
}

// PlanPlatformGTE applies the GTE predicate on the "plan_platform" field.
func PlanPlatformGTE(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGTE(FieldPlanPlatform, v))
}

// PlanPlatformLT applies the LT predicate on the "plan_platform" field.
func PlanPlatformLT(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLT(FieldPlanPlatform, v))
}

// PlanPlatformLTE applies the LTE predicate on the "plan_platform" field.
func PlanPlatformLTE(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLTE(FieldPlanPlatform, v))
}

// PlanPlatformContains applies the Contains predicate on the "plan_platform" field.
func PlanPlatformContains(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldContains(FieldPlanPlatform, v))
}

// PlanPlatformHasPrefix applies the HasPrefix predicate on the "plan_platform" field.
func PlanPlatformHasPrefix(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldHasPrefix(FieldPlanPlatform, v))
}

// PlanPlatformHasSuffix applies the HasSuffix predicate on the "plan_platform" field.
func PlanPlatformHasSuffix(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldHasSuffix(FieldPlanPlatform, v))
}

// PlanPlatformEqualFold applies the EqualFold predicate on the "plan_platform" field.
func PlanPlatformEqualFold(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEqualFold(FieldPlanPlatform, v))
}

// PlanPlatformContainsFold applies the ContainsFold predicate on the "plan_platform" field.
func PlanPlatformContainsFold(v string) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldContainsFold(FieldPlanPlatform, v))
}
