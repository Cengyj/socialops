...
type UserEdges struct {
	...
	// SocialAccounts holds the value of the social_accounts edge.
	SocialAccounts []*SocialAccount `json:"social_accounts,omitempty"`
	// SocialTaskLogs holds the value of the social_task_logs edge.
	SocialTaskLogs []*SocialTaskLog `json:"social_task_logs,omitempty"`
	// SocialIps holds the value of the social_ips edge.
	SocialIps []*SocialIP `json:"social_ips,omitempty"`
...
// SocialAccountsOrErr returns the SocialAccounts value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) SocialAccountsOrErr() ([]*SocialAccount, error) {
	if e.loadedTypes[12] {
		return e.SocialAccounts, nil
	}
	return nil, &NotLoadedError{edge: "social_accounts"}
}

// SocialTaskLogsOrErr returns the SocialTaskLogs value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) SocialTaskLogsOrErr() ([]*SocialTaskLog, error) {
	if e.loadedTypes[13] {
		return e.SocialTaskLogs, nil
	}
	return nil, &NotLoadedError{edge: "social_task_logs"}
}

// SocialIpsOrErr returns the SocialIps value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) SocialIpsOrErr() ([]*SocialIP, error) {
	if e.loadedTypes[14] {
		return e.SocialIps, nil
	}
	return nil, &NotLoadedError{edge: "social_ips"}
}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldConcurrency, user.FieldTokenVersion, user.FieldRpmLimit:
...
// QuerySocialAccounts queries the "social_accounts" edge of the User entity.
func (_m *User) QuerySocialAccounts() *SocialAccountQuery {
	return NewUserClient(_m.config).QuerySocialAccounts(_m)
}

// QuerySocialTaskLogs queries the "social_task_logs" edge of the User entity.
func (_m *User) QuerySocialTaskLogs() *SocialTaskLogQuery {
	return NewUserClient(_m.config).QuerySocialTaskLogs(_m)
}

// QuerySocialIps queries the "social_ips" edge of the User entity.
func (_m *User) QuerySocialIps() *SocialIPQuery {
	return NewUserClient(_m.config).QuerySocialIps(_m)
}
