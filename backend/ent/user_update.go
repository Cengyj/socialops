...
// AddSocialAccountIDs adds the "social_accounts" edge to the SocialAccount entity by IDs.
func (_u *UserUpdate) AddSocialAccountIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddSocialAccountIDs(ids...)
	return _u
}

// AddSocialAccounts adds the "social_accounts" edges to the SocialAccount entity.
func (_u *UserUpdate) AddSocialAccounts(v ...*SocialAccount) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddSocialAccountIDs(ids...)
}

// AddSocialTaskLogIDs adds the "social_task_logs" edge to the SocialTaskLog entity by IDs.
func (_u *UserUpdate) AddSocialTaskLogIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddSocialTaskLogIDs(ids...)
	return _u
}

// AddSocialTaskLogs adds the "social_task_logs" edges to the SocialTaskLog entity.
func (_u *UserUpdate) AddSocialTaskLogs(v ...*SocialTaskLog) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddSocialTaskLogIDs(ids...)
}

// AddSocialIPIDs adds the "social_ips" edge to the SocialIP entity by IDs.
func (_u *UserUpdate) AddSocialIPIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddSocialIPIDs(ids...)
	return _u
}

// AddSocialIps adds the "social_ips" edges to the SocialIP entity.
func (_u *UserUpdate) AddSocialIps(v ...*SocialIP) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddSocialIPIDs(ids...)
}
...
// ClearSocialAccounts clears all "social_accounts" edges to the SocialAccount entity.
func (_u *UserUpdate) ClearSocialAccounts() *UserUpdate {
	_u.mutation.ClearSocialAccounts()
	return _u
}

// RemoveSocialAccountIDs removes the "social_accounts" edge to SocialAccount entities by IDs.
func (_u *UserUpdate) RemoveSocialAccountIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveSocialAccountIDs(ids...)
	return _u
}

// RemoveSocialAccounts removes "social_accounts" edges to SocialAccount entities.
func (_u *UserUpdate) RemoveSocialAccounts(v ...*SocialAccount) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveSocialAccountIDs(ids...)
}

// ClearSocialTaskLogs clears all "social_task_logs" edges to the SocialTaskLog entity.
func (_u *UserUpdate) ClearSocialTaskLogs() *UserUpdate {
	_u.mutation.ClearSocialTaskLogs()
	return _u
}

// RemoveSocialTaskLogIDs removes the "social_task_logs" edge to SocialTaskLog entities by IDs.
func (_u *UserUpdate) RemoveSocialTaskLogIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveSocialTaskLogIDs(ids...)
	return _u
}

// RemoveSocialTaskLogs removes "social_task_logs" edges to SocialTaskLog entities.
func (_u *UserUpdate) RemoveSocialTaskLogs(v ...*SocialTaskLog) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveSocialTaskLogIDs(ids...)
}

// ClearSocialIps clears all "social_ips" edges to the SocialIP entity.
func (_u *UserUpdate) ClearSocialIps() *UserUpdate {
	_u.mutation.ClearSocialIps()
	return _u
}

// RemoveSocialIPIDs removes the "social_ips" edge to SocialIP entities by IDs.
func (_u *UserUpdate) RemoveSocialIPIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveSocialIPIDs(ids...)
	return _u
}

// RemoveSocialIps removes "social_ips" edges to SocialIP entities.
func (_u *UserUpdate) RemoveSocialIps(v ...*SocialIP) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveSocialIPIDs(ids...)
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.SocialAccountsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialAccountsTable,
			Columns: []string{user.SocialAccountsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedSocialAccountsIDs(); len(nodes) > 0 && !_u.mutation.SocialAccountsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialAccountsTable,
	...
	if nodes := _u.mutation.SocialAccountsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialAccountsTable,
	...
	if _u.mutation.SocialTaskLogsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialTaskLogsTable,
			Columns: []string{user.SocialTaskLogsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedSocialTaskLogsIDs(); len(nodes) > 0 && !_u.mutation.SocialTaskLogsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialTaskLogsTable,
	...
	if nodes := _u.mutation.SocialTaskLogsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialTaskLogsTable,
	...
	if _u.mutation.SocialIpsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialIpsTable,
			Columns: []string{user.SocialIpsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(socialip.FieldID, field.TypeInt64),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := _u.mutation.RemovedSocialIpsIDs(); len(nodes) > 0 && !_u.mutation.SocialIpsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialIpsTable,
	...
	if nodes := _u.mutation.SocialIpsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialIpsTable,
...
// AddSocialAccountIDs adds the "social_accounts" edge to the SocialAccount entity by IDs.
func (_u *UserUpdateOne) AddSocialAccountIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSocialAccountIDs(ids...)
	return _u
}

// AddSocialAccounts adds the "social_accounts" edges to the SocialAccount entity.
func (_u *UserUpdateOne) AddSocialAccounts(v ...*SocialAccount) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSocialTaskLogIDs adds the "social_task_logs" edge to the SocialTaskLog entity by IDs.
func (_u *UserUpdateOne) AddSocialTaskLogIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSocialTaskLogIDs(ids...)
	return _u
}

// AddSocialTaskLogs adds the "social_task_logs" edges to the SocialTaskLog entity.
func (_u *UserUpdateOne) AddSocialTaskLogs(v ...*SocialTaskLog) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSocialIPIDs adds the "social_ips" edge to the SocialIP entity by IDs.
func (_u *UserUpdateOne) AddSocialIPIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSocialIPIDs(ids...)
	return _u
}

// AddSocialIps adds the "social_ips" edges to the SocialIP entity.
func (_u *UserUpdateOne) AddSocialIps(v ...*SocialIP) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveSocialAccountIDs removes the "social_accounts" edge to SocialAccount entities by IDs.
func (_u *UserUpdateOne) RemoveSocialAccountIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSocialAccountIDs(ids...)
	return _u
}

// RemoveSocialAccounts removes "social_accounts" edges to SocialAccount entities.
func (_u *UserUpdateOne) RemoveSocialAccounts(v ...*SocialAccount) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSocialTaskLogs clears all "social_task_logs" edges to the SocialTaskLog entity.
func (_u *UserUpdateOne) ClearSocialTaskLogs() *UserUpdateOne {
	_u.mutation.ClearSocialTaskLogs()
	return _u
}

// RemoveSocialTaskLogIDs removes the "social_task_logs" edge to SocialTaskLog entities by IDs.
func (_u *UserUpdateOne) RemoveSocialTaskLogIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSocialTaskLogIDs(ids...)
	return _u
}

// RemoveSocialTaskLogs removes "social_task_logs" edges to SocialTaskLog entities.
func (_u *UserUpdateOne) RemoveSocialTaskLogs(v ...*SocialTaskLog) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSocialIps clears all "social_ips" edges to the SocialIP entity.
func (_u *UserUpdateOne) ClearSocialIps() *UserUpdateOne {
	_u.mutation.ClearSocialIps()
	return _u
}

// RemoveSocialIPIDs removes the "social_ips" edge to SocialIP entities by IDs.
func (_u *UserUpdateOne) RemoveSocialIPIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSocialIPIDs(ids...)
	return _u
}

// RemoveSocialIps removes "social_ips" edges to SocialIP entities.
func (_u *UserUpdateOne) RemoveSocialIps(v ...*SocialIP) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
