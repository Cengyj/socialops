...
type UserSubscription struct {
	...
	// PlanPlatform holds the value of the "plan_platform" field.
	PlanPlatform string `json:"plan_platform,omitempty"`
...
func (*UserSubscription) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usersubscription.FieldPlanName, usersubscription.FieldPlanPlatform, usersubscription.FieldStatus, usersubscription.FieldNotes:
...
func (_m *UserSubscription) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usersubscription.FieldPlanPlatform:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field plan_platform", values[i])
			} else if value.Valid {
				_m.PlanPlatform = value.String
			}
...
func (_m *UserSubscription) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("plan_platform=")
	builder.WriteString(_m.PlanPlatform)
	builder.WriteString(", ")
