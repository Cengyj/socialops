...
func (f SocialAccountFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SocialAccountMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SocialAccountMutation", m)
}

// The SocialIPFunc type is an adapter to allow the use of ordinary
// function as SocialIP mutator.
type SocialIPFunc func(context.Context, *ent.SocialIPMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SocialIPFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SocialIPMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SocialIPMutation", m)
}

// The SocialTaskLogFunc type is an adapter to allow the use of ordinary
// function as SocialTaskLog mutator.
type SocialTaskLogFunc func(context.Context, *ent.SocialTaskLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SocialTaskLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SocialTaskLogMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SocialTaskLogMutation", m)
}
