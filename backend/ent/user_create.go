...
func (_c *UserCreate) AddSocialAccountIDs(ids ...int64) *UserCreate {
	_c.mutation.AddSocialAccountIDs(ids...)
	return _c
}

// AddSocialAccounts adds the "social_accounts" edges to the SocialAccount entity.
func (_c *UserCreate) AddSocialAccounts(v ...*SocialAccount) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSocialAccountIDs(ids...)
}

// AddSocialTaskLogIDs adds the "social_task_logs" edge to the SocialTaskLog entity by IDs.
func (_c *UserCreate) AddSocialTaskLogIDs(ids ...int64) *UserCreate {
	_c.mutation.AddSocialTaskLogIDs(ids...)
	return _c
}

// AddSocialTaskLogs adds the "social_task_logs" edges to the SocialTaskLog entity.
func (_c *UserCreate) AddSocialTaskLogs(v ...*SocialTaskLog) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSocialTaskLogIDs(ids...)
}

// AddSocialIPIDs adds the "social_ips" edge to the SocialIP entity by IDs.
func (_c *UserCreate) AddSocialIPIDs(ids ...int64) *UserCreate {
	_c.mutation.AddSocialIPIDs(ids...)
	return _c
}

// AddSocialIps adds the "social_ips" edges to the SocialIP entity.
func (_c *UserCreate) AddSocialIps(v ...*SocialIP) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddSocialIPIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.SocialAccountsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.SocialTaskLogsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.SocialIpsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
