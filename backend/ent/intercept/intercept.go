...
// The SocialAccountFunc type is an adapter to allow the use of ordinary function as a Querier.
type SocialAccountFunc func(context.Context, *ent.SocialAccountQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SocialAccountFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SocialAccountQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SocialAccountQuery", q)
}

// The TraverseSocialAccount type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSocialAccount func(context.Context, *ent.SocialAccountQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSocialAccount) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSocialAccount) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SocialAccountQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SocialAccountQuery", q)
}

// The SocialIPFunc type is an adapter to allow the use of ordinary function as a Querier.
type SocialIPFunc func(context.Context, *ent.SocialIPQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SocialIPFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SocialIPQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SocialIPQuery", q)
}

// The TraverseSocialIP type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSocialIP func(context.Context, *ent.SocialIPQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSocialIP) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSocialIP) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SocialIPQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SocialIPQuery", q)
}

// The SocialTaskLogFunc type is an adapter to allow the use of ordinary function as a Querier.
type SocialTaskLogFunc func(context.Context, *ent.SocialTaskLogQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SocialTaskLogFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SocialTaskLogQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SocialTaskLogQuery", q)
}

// The TraverseSocialTaskLog type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSocialTaskLog func(context.Context, *ent.SocialTaskLogQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSocialTaskLog) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSocialTaskLog) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SocialTaskLogQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SocialTaskLogQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.SocialAccountQuery:
		return &query[*ent.SocialAccountQuery, predicate.SocialAccount, socialaccount.OrderOption]{typ: ent.TypeSocialAccount, tq: q}, nil
	case *ent.SocialIPQuery:
		return &query[*ent.SocialIPQuery, predicate.SocialIP, socialip.OrderOption]{typ: ent.TypeSocialIP, tq: q}, nil
	case *ent.SocialTaskLogQuery:
		return &query[*ent.SocialTaskLogQuery, predicate.SocialTaskLog, socialtasklog.OrderOption]{typ: ent.TypeSocialTaskLog, tq: q}, nil
