...
const (
	// Label holds the string label denoting the globalproxy type in the database.
	Label = "global_proxy"
	...
	FieldRemark = "remark"
	// Table holds the table name of the globalproxy in the database.
	Table = "global_proxies"
)

// Columns holds all SQL columns for globalproxy fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the GlobalProxy queries.
