...
func NewSettingHandler(settingService *service.SettingService, emailService *service.EmailService, turnstileService *service.TurnstileService, paymentConfigService *service.PaymentConfigService, paymentService *service.PaymentService, userAttributeService *service.UserAttributeService) *SettingHandler {
...
func preserveOmittedUpdateSettingsFields(req *UpdateSettingsRequest, previous *service.SystemSettings, fields map[string]json.RawMessage) {
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	if err := json.Unmarshal(rawBody, &requestFields); err != nil {
		response.BadRequest(c, "Invalid request: "+err.Error())
		return
	}
	...
	preserveOmittedUpdateSettingsFields(&req, previousSettings, requestFields)
