...
import (
	...
	"github.com/Wei-Shaw/socialops/internal/payment/provider"
...
// historical ciphertext with no/invalid TOTP_ENCRYPTION_KEY — are treated as empty,
// letting the admin re-enter the config via the UI to complete the migration.
//
// Deprecated historical ciphertext read path: remove the AES branch and encryptionKey
// field after live deployments have re-saved their provider configs for a few
// releases.
