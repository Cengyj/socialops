...
// Group entity removed in Phase 2D — returns empty map.
func (s *PaymentConfigService) GetGroupInfoMap(_ context.Context, _ []*dbent.SubscriptionPlan) map[int64]PlanGroupInfo {
	return nil
}
