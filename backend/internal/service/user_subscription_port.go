...
type UserSubscriptionRepository interface {
	...
	List(ctx context.Context, params pagination.PaginationParams, userID, groupID, planID *int64, status, platform, sortBy, sortOrder string) ([]UserSubscription, *pagination.PaginationResult, error)
