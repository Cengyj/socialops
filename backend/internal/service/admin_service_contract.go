...
// AdminService defines the operations used by SocialOps admin handlers for
// users, balances, redeem codes, auth identities, and task billing summaries.
type AdminService interface {
	...
	GetUserUsageStats(ctx context.Context, userID int64) (*AdminUserUsageStats, error)
...
var ErrAdminServiceNotConfigured = infraerrors.New(http.StatusNotImplemented, "ADMIN_SERVICE_NOT_CONFIGURED", "admin service is not configured")
...
func (s *adminServiceSkeleton) GetUserUsageStats(_ context.Context, userID int64) (*AdminUserUsageStats, error) {
	return nil, ErrAdminServiceNotConfigured
}
