# =============================================================================
# SocialOps Multi-Stage Dockerfile
# =============================================================================
...
LABEL org.opencontainers.image.source="https://github.com/Wei-Shaw/socialops"
...
RUN addgroup -g 1000 socialops && \
    adduser -u 1000 -G socialops -s /bin/sh -D socialops
...
# Copy entrypoint script (fixes volume permissions then drops to socialops)
...
# Run the application (entrypoint fixes /app/data ownership then execs as socialops)
