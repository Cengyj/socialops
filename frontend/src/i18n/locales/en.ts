export default {
  ...
  "taskSettings": {
    "title": "Task Settings",
    "description": "Maintain reusable execution parameter templates for follow, like, retweet, and post tasks. This page only configures parameters that account task execution actually reuses.",
    ...
    "typeDescriptions": {
      ...
      "post": "Distribute text publishing tasks from a content pool."
    },
    "typeRequirements": {
    ...
    "media": {
      "postTextOnlyHint": "Post templates currently configure text content only. Image or video attachments are not connected to this template yet."
    },
    "validation": {
    ...
    "empty": {
      ...
      "description": "Create follow, like, retweet, or post parameter templates before submitting account tasks that need parameters."
    },
    "emptyFiltered": {
