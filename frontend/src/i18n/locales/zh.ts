export default {
  ...
  "taskSettings": {
    "title": "执行参数模板管理",
    "description": "管理关注、点赞、转发和发帖任务复用的执行参数模板。这里只配置账号任务执行时真正需要复用的参数。",
    ...
    "media": {
      "postTextOnlyHint": "当前发帖模板仅配置文本内容池。图片或视频附件暂未接入此模板，请勿将媒体参数作为模板能力使用。"
    },
    "validation": {
      "valid": "模板完整",
      "invalid": "模板需补齐",
    ...
    "empty": {
      "title": "暂无模板",
      "description": "请先创建关注、点赞、转发或发帖参数模板，再在账号工作台中提交需要参数的任务。"
    },
    "emptyFiltered": {
      "title": "此类型暂无模板",
