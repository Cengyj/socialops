export default {
  ...
  admin: {
    ...
    socialAccountWorkbench: {
      ...
      registerNotConfigured: '真实社交平台注册器未接入，注册失败关闭且不会入库。',
      tabs: {
        management: '账号管理',
        managementDescription: '导入、注册和整理社交账号资料，准备进入总账号池分配流程',
        managementCount: '{count} 条记录',
        pool: '总账号池',
        poolDescription: '查看池内账号分配状态，处理分配、回收、导出和批量清理',
        poolCount: '{count} 个未分配'
      },
      stats: {
        total: '账号记录',
        stored: '已入库',
      ...
      executionLog: {
        title: '执行日志',
        recentTitle: '最近执行日志',
        recentHint: '日志弹窗可随时关闭；未接入真实执行器的动作会失败关闭。',
        ...
        copy: '复制日志',
        copied: '执行日志已复制',
        closeHint: '关闭弹窗只会隐藏终端，执行仍会在最近日志中继续。',
      ...
      form: {
        ...
        fileHint: '字段格式：社交账号、密码、手机号、邮箱账号、邮箱密码、绑定 IP、备注。上传会调用后端导入总账号池并去重。'
      },
      uploadPreview: {
        total: '总数',
        success: '成功',
    ...
    accounts: {
      title: '社交账号工作台',
      description: '注册、导入并整理社交账号，准备进入总账号池分配流程。',
    ...
    usage: {
      title: '使用记录',
      description: '查看 SocialOps 操作使用记录',
      records: '操作记录',
      empty: '暂无使用记录。',
      user: '用户',
      failedToLoad: '加载管理端使用记录失败',
      cleanupQueued: '清理任务已提交',
      cleanupFailed: '提交清理任务失败',
      billingModeToken: '金额',
      billingModePerRequest: '按动作',
      billingModeImage: '按动作',
      cleanup: {
        button: '清理'
      }
    },
    ...
    settings: {
      title: '系统设置',
      description: '管理注册、安全、用户、SocialOps 默认值和支付设置',
      tabs: {
        general: '基础',
        security: '安全',
        users: '用户',
      ...
      authSourceDefaults: {
        title: '认证来源默认值',
        description: '按注册来源配置默认余额、并发、订阅和首次绑定赠送规则。',
        requireEmailLabel: '第三方注册必须补充邮箱',
        grantOnFirstBindLabel: '首次绑定时发放',
        sources: {
          email: { title: '邮箱注册' },
          linuxdo: { title: 'LinuxDo 注册' },
          oidc: { title: 'OIDC 注册' },
          wechat: { title: '微信注册' },
          github: { title: 'GitHub 注册' },
          google: { title: 'Google 注册' },
          dingtalk: { title: '钉钉注册' }
        }
      },
      defaultBalance: '默认余额',
      ...
      social: {
        title: 'SocialOps 默认值',
        taskWorkers: '任务执行线程数',
        taskInterval: '任务间隔（毫秒）',
        ipCheckInterval: 'IP 检测间隔（分钟）',
        maxAccountsPerUser: '单用户最大账号数'
      },
      registration: {
        title: '注册设置',
        enabled: '允许注册',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        ...
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">SocialOps 用于集中管理网站总账号池、用户订阅和社交任务执行。</p><p style="margin-bottom: 12px;"><b>核心区域：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li><b>社交账号</b> - 导入、注册、分配和回收账号</li><li><b>任务运营</b> - 跟踪关注、私信、发帖、点赞和登录检测</li><li><b>SaaS 计费</b> - 管理套餐、订单、兑换码和推广返利</li></ul></div>',
        nextBtn: '开始',
        prevBtn: '跳过'
      },
      accountManage: {
        title: '社交账号工作台',
        description: '<div style="line-height: 1.7;"><p>注册、导入并整理社交账号，准备进入可分配账号池。</p></div>'
      },
      proxies: {
        title: '代理管理',
      ...
      usage: {
        title: '操作记录',
        description: '<div style="line-height: 1.7;"><p>使用记录页面用于追踪社交任务执行和账号操作历史。</p></div>'
      },
      settings: {
        title: '平台设置',
