          ...
          <template #cell-subscriptions="{ row }">
            ...
            >
              <span
                ...
                class="inline-flex items-center gap-1.5 rounded-md border border-gray-200 bg-gray-50 px-2 py-1 text-xs font-medium text-gray-700 dark:border-dark-600 dark:bg-dark-700/50 dark:text-gray-200"
              >
                <span>{{ sub.group?.name || t('admin.users.subscription') }}</span>
                <span v-if="sub.expires_at" class="text-gray-400 dark:text-dark-400">
