/**
 * Vue Router configuration for SocialOps frontend
...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'AdminTotalAccounts',
    component: () => import('@/views/admin/TotalAccountsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
...
router.beforeEach(async (to, _from, next) => {
  ...
  if (to.name === 'CustomPage') {
    ...
    if (menuItem?.label) {
      const siteName = appStore.siteName || 'SocialOps'
