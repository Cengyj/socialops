#!/bin/bash
# =============================================================================
# SocialOps Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for SocialOps:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/Wei-Shaw/socialops/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  SocialOps Deployment Preparation"
    echo "=========================================="
    echo ""
    ...
    print_warning "Back up .env securely; it contains database, JWT, and TOTP secrets."
    print_warning "Do not share .env publicly."
    echo ""
    ...
    echo ""
    echo "  3. View logs:"
    echo "     docker-compose logs -f socialops"
    echo ""
